...
for (let i = 0; i < data.length; i++){
  if (data[i].years >= '1900-2000')
  deadArtist.push(data[i].name)
}
return deadArtist
}
...
function addArtist(data, id, name, years, genre, nationailty, bio) {
data.push({id, name, years, genre, nationailty, bio})
return data;
};

console.log(addArtist(artists, '20', 'Carson Myers', '2000 - Current Day', 'Web Design', 'I am a white man', 'I was born in Utah. I still live in Utah'))
...
for (let i = 0; i < data.length; i++){
  ...
  lotsOfpaintings.push(data[i].name)
}
